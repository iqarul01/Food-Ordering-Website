        ...
        <div id="service-slider" class="owl-carousel">
          <div class="item">
            ...
            <div class="image">
              ...
              <h3><a href="./account/register.php">PineApple Juice</a></h3>
              <p>Enjoy Delicious Food!</p>
            </div>
          </div>
          <div class="item">
            <div class="item_inner">
              ...
              <h3><a href="./account/register.php">Chicken Biriyani</a></h3>
              <p>Enjoy Delicious Food!</p>
            </div>
          </div>
          <div class="item">
            <div class="item_inner">
              ...
              <h3><a href="./account/register.php">Idly Vada Set</a></h3>
              <p>Enjoy Delicious Food!</p>
            </div>
          </div>
          <div class="item">
            <div class="item_inner">
              ...
              <h3><a href="./account/register.php">Strawberry Cotton Candy</a></h3>
              <p>Enjoy Delicious Food!</p>
            </div>
          </div>
        </div>
     ...
     <div class="col-md-12 text-center">
        ...
        <div class="work-filter">
          <ul class="text-center">
             ...
             <li><a href="javascript:;" data-filter=".starters" class="filter">Breakfast</a></li>
             <li><a href="javascript:;" data-filter=".drinks" class="filter">Lunch</a></li>
             <li><a href="javascript:;" data-filter=".dinner" class="filter">Juices & Drinks</a></li>
             <li><a href="javascript:;" data-filter=".lunch" class="filter">Snacks</a></li>
          </ul>
        </div>
      </div>
    </div>
