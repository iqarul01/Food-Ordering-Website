...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form method="post" action="routers/rpage.php" class="col s12">
        <div class="row">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input name="mail" id="mail" type="email" data-error=".errorTxt4">
            <label for="mail">Mail</label>
			<div class="errorTxt4"></div>			
          </div>
        <div class="row margin">
          <div class="input-field col s12">
          <i class="fa-sharp fa-solid fa-location-dot prefix"></i>
        ...
        <div class="row">
          <div class="input-field col s12">
			<input type="submit" class="btn waves-effect waves-light col s12" name="submit" value="Register"></input>
          </div>
          <div class="input-field col s12">
